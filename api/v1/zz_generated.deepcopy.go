...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConditionalReplicalTargetSpec) DeepCopyInto(out *ConditionalReplicalTargetSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConditionalReplicalTargetSpec.
func (in *ConditionalReplicalTargetSpec) DeepCopy() *ConditionalReplicalTargetSpec {
	if in == nil {
		return nil
	}
	out := new(ConditionalReplicalTargetSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CustomHorizontalPodAutoscalerSpec) DeepCopyInto(out *CustomHorizontalPodAutoscalerSpec) {
	*out = *in
	...
	if in.ConditionalReplicalTargets != nil {
		in, out := &in.ConditionalReplicalTargets, &out.ConditionalReplicalTargets
		*out = make([]ConditionalReplicalTargetSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
