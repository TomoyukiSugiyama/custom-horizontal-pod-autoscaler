...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConditionalReplicasTargetSpec) DeepCopyInto(out *ConditionalReplicasTargetSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConditionalReplicasTargetSpec.
func (in *ConditionalReplicasTargetSpec) DeepCopy() *ConditionalReplicasTargetSpec {
	if in == nil {
		return nil
	}
	out := new(ConditionalReplicasTargetSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CustomHorizontalPodAutoscalerSpec) DeepCopyInto(out *CustomHorizontalPodAutoscalerSpec) {
	*out = *in
	...
	if in.ConditionalReplicasTargets != nil {
		in, out := &in.ConditionalReplicasTargets, &out.ConditionalReplicasTargets
		*out = make([]ConditionalReplicasTargetSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
